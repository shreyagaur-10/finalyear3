...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-xl border border-white/10 bg-slate-900/98 p-1 text-slate-100 shadow-2xl backdrop-blur-xl',
      className
    )}
    {...props}
  />
...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[12rem] overflow-hidden rounded-xl border border-white/10 bg-slate-900/98 p-1.5 text-slate-100 shadow-2xl backdrop-blur-xl',
        className
      )}
      {...props}
    />
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'relative flex cursor-pointer select-none items-center rounded-lg py-2 pl-8 pr-2 text-sm outline-none transition-colors focus:bg-white/10',
      className
    )}
    checked={checked}
    {...props}
